# -*- coding: utf-8 -*-
"""Tic-Tac-Toe Tabular Q-Learning V6.1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZxlMEWdNkpXGZyr0SOg1YhlqhgjS4tV-
"""
...
q_table = np.zeros((3 ** 16, 16))

# Learning parameters
episodes = 2000
learning_rate = 0.01
num_random_episodes = 1
min_epsilon, max_epsilon = 0.5, 1
...
for episode in range(episodes):
  ...
  while not isinstance(terminal, int):
    ...
    if np.random.random() < epsilon:
      ...
      action = 4 * action_square[0] + action_square[1]
    else:
      actions = q_table[current_state] * turn
      for action in np.argsort(actions)[::-1]:
        action_square = [action // 4, action % 4]
  ...
  if episode % 10 == 0:
    try:
      ...
      plt.show()
      print ("Episode: {}, Epsilon: {:.4f}, Win Probability: {:.4f}, Draw Probability: {:.4f}".format(episode + 1, epsilon, win_probs[-1], draw_probs[-1]))
    except:
      pass
